...
\noemi{Other approaches:}
\paragraph{RBE.} Moves the interaction with the key database from the encryptor side to the decryptor. All \noemi{check this} of the practical constructions of RBE use the so-called ``slotted RBE'' paradigm, which \noemi{...}
