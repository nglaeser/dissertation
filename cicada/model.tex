\section{System Model}\label{sec:cicada_model}
...
An adversary may attempt to read ballots/bids before the submission phase is complete. This is prevented by the security properties of (H)TLPs (\Cref{sec:tlp}) assuming the delay $\Ttime$ is longer than the submission phase.