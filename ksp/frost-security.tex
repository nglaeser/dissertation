...
\begin{figure}
    ...
    \end{pchstack}
    \caption{Oracles for $\ufgame$ experiment (see \Cref{fig:hc-suf-2}) tailored to the HC-FROST2 protocol (\Cref{fig:hc-frost}).}
    \label{fig:oracles-hc-frost}
\end{figure}

\begin{theorem}
    The hot/cold variant of FROST2 described in \Cref{sec:frost} is unforgeable assuming OMDL.
\end{theorem}
