...
\noemi{Currently, we require the prover to additionally run $\Pi.\vrfy$ to create the verification trace $\com$. Is there a way to separate/outsource this to another party to reduce the added computational burden on a party already spending so much power to compute the proof?}
