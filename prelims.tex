...
\todo{NP-languages and relations} \noemi{A language is some subset of strings. Every NP language has a corresponding polynomially-decidable relation such that if $x \in \Lang, \exists w \suchthat (x,w) \in \Rel_\Lang$ where $w$ is polynomial in $\sizeof{x}$.}
